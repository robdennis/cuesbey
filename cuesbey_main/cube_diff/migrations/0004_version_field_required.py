...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Card.versions'
        db.alter_column(u'cube_diff_card', 'versions', self.gf('jsonfield.fields.JSONField')(default="{}"))

    def backwards(self, orm):

        # Changing field 'Card.versions'
        db.alter_column(u'cube_diff_card', 'versions', self.gf('jsonfield.fields.JSONField')(null=True))
